...
- uses current model through the current sdk and Gemini through `@ai-sdk/google`
...
- Keep the task output as plain MarkdownReuse existing auth, Prisma, Trigger.dev, and Gemini and current model patterns
