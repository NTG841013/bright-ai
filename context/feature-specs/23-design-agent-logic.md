...
- use OpenRouter (`@ai-sdk/openai`) to interpret the user prompt
- model: `openrouter/free` (reverted to "9 edges" state)
...
## Dependencies
All packages are already installed. `OPENROUTER_API_KEY` is required in `.env.local`.
