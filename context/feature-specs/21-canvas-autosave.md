...
2.Add canvas save/load API routes. Create: `PUT /api/projects/[projectId]/canvas` This route should:
...
Create: `GET /api/projects/[projectId]/canvas` This route should:
