...
Configure the `Liveblocks.config.ts` file at the project root.
...
Add a helper that deterministically maps a user ID to a consistent color from a mixed palette.
