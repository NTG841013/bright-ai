...
Background tasks are deployed independently of Vercel. To automate this:

1. Generate a **Personal Access Token** in the Trigger.dev dashboard (starting with `tr_pat_`).
